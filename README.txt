...
Make sure that your pp2 name is the same as the one used in this program.
If your pp2 is written in C or C++, you must modify the StartRemotePeers.java file
...
2. Copy *.java and compileJava files to your working directory where your pp2 resides.
