...
Make sure that your peerProcess2 name is the same as the one used in this program.
If your peerProcess2 is written in C or C++, you must modify the StartRemotePeers.java file
...
2. Copy *.java and compileJava files to your working directory where your peerProcess2 resides.
